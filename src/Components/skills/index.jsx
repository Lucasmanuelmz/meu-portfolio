...
export default function SkillsComponent(
  { lightModeSkills, lightModeSkill }) {
  return (
    <section id="skills" className={lightModeSkills}>
      <h3>Minhas Habilidades</h3>
      <div className="skills-icons">
        <div data-aos="fade-up" className={lightModeSkill}>
        ...
        <div data-aos="fade-down" className={lightModeSkill}>
          <svg viewBox="0 0 128 128">
            <path
              fill="#1572B6"
...
SkillsComponent.propTypes = {
  lightModeSkills: PropTypes.string.isRequired, 
  lightModeSkill: PropTypes.string.isRequired
}
